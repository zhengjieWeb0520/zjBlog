  ...
  initMap = () => {
    ...
    esriLoader
      ...
      .then(([
        ...
        // 定义图层
        const gaodeDigitalLayer = new gaodeLayer({
          id: 'gaode_road',
          layertype: 'road',
          visible: true
        })
        const gaodeSatelliteLayer = new gaodeLayer({
          id: 'gaode_st',
          layertype: 'st',
          visible: false
        })
        const gaodeLabelLayer = new gaodeLayer({
          id: 'gaode_label_st',
          layertype: 'label',
          visible: false
        })
        this.allBaseLayer = [gaodeDigitalLayer, gaodeSatelliteLayer, gaodeLabelLayer]
