  ...
  initMap = () => {
    ...
    esriLoader
      ...
      .then(([
        ...
        // 定义图层
        const tdtDigitalLayer = new tdtLayer({
          id: 'tdt_road',
          layertype: 'road',
          visible: true
        })
        const tdtSatelliteLayer = new tdtLayer({
          id: 'tdt_st',
          layertype: 'st',
          visible: false
        })
        const tdtLabelLayer = new tdtLayer({
          id: 'tdt_label_st_road',
          layertype: 'label',
          visible: true
        })
        const tdtTedrLayer = new tdtLayer({
          id: 'tdt_ter',
          layertype: 'ter',
          visible: false
        })
        this.allBaseLayer = [tdtDigitalLayer, tdtSatelliteLayer, tdtLabelLayer, tdtTedrLayer]
