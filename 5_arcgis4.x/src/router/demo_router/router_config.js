 ...
 * @LastEditors: 郑杰14
 * @LastEditTime: 2021-02-05 16:45:27
 * @Description: demo 路由
 */
...
const OperateMeasure = lazy(() => import(/* webpackChunkName: 'operateMessure' */ '../../component/demoComponent/5_operate/3_messure'))
const OperateDistance = lazy(() => import(/* webpackChunkName: 'operateDistance' */ '../../component/demoComponent/5_operate/5_distance'))
const OperateAttrSearch = lazy(() => import(/* webpackChunkName: 'operateAttrSearch' */ '../../component/demoComponent/5_operate/6_attrSearch'))
const OperateSpaceSearch = lazy(() => import(/* webpackChunkName: 'operateSpaceSearch' */ '../../component/demoComponent/5_operate/7_spaceSearch'))
...
const BasicCsvLayer = lazy(() => import(/* webpackChunkName: 'csvLayer' */ '../../component/demoComponent/7_basicLayers/7_csvLayer'))
const BasicGeoJsonLayer = lazy(() => import(/* webpackChunkName: 'geoJsonLayer' */ '../../component/demoComponent/7_basicLayers/8_geoJsonLayer'))
const ExtendClusterLayer = lazy(() => import(/* webpackChunkName: 'clusterLayer' */ '../../component/demoComponent/8_extendLayers/1_clusterLayer'))
const ExtendFlareClusterLayer = lazy(() => import(/* webpackChunkName: 'flareclusterLayer' */ '../../component/demoComponent/8_extendLayers/5_flareClusterLayer'))
...
const TdtOnlineWgs84 = lazy(() => import(/* webpackChunkName: 'tdtOnlineWgs84' */ '../../component/demoComponent/4_baseMap/6_tdtOnlineWgs84'))
export default [
  {
    name: '前言',
    path: 'preface',
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            name: '计算两点距离',
            path: 'distance',
            component: <OperateDistance />
          },
          {
            name: '属性查询',
            path: 'attrSearch',
            component: <OperateAttrSearch />
          },
          {
            name: '空间查询',
            path: 'spaceSearch',
            component: <OperateSpaceSearch />
          },
          {
            name: '卷帘',
            path: 'rpllerBlind',
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            name: 'csvLayer',
            path: 'csvLayer',
            component: <BasicCsvLayer />
          },
          {
            name: 'geoJsonLayer',
            path: 'geoJsonLayer',
            component: <BasicGeoJsonLayer />
          }
        ]
      },
      {
        ...
        children: [
          ...
          {
            name: '聚合图层2',
            path: 'flareClusterLayer',
            component: <ExtendFlareClusterLayer />
          },
          {
            name: '格网图层',
            path: 'gridLayer',
