...
L.TileLayer.WMTS = L.TileLayer.extend({
    ...
    initialize: function (url, options) { // (String, Object)
        ...
        for (var i in options) {
            ...
            if (!this.options.hasOwnProperty(i) && i != "matrixIds" && i !== "wkid") {
    ...
    getTileUrl: function (coords) { // (Point, Number) -> String
        ...
        var tilematrix = this.wmtsParams.tilematrixSet.indexOf('4326') !== -1 ? this.wmtsParams.tilematrixSet + ":" + ident : ident
    ...
    getDefaultMatrix: function () {
        var lnglat = [20037508.3428, -20037508.3428]
        if (this.wmtsParams.tilematrixSet.indexOf('4326') !== 1 || this.wmtsParams.tilematrixSet === 'c') {
            lnglat = [90, -180]
        }
        /**
        ...
        for (var i = 0; i < 22; i++) {
            matrixIds3857[i] = {
                identifier: "" + i,
                topLeftCorner: new L.LatLng(lnglat[0], lnglat[1])
            };
        }
