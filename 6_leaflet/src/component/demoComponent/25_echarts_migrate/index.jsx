...
export default function InitMap () {
  ...
  const initMap = () => {
    const baseLayer = L.tileLayer('http://map.geoq.cn/ArcGIS/rest/services/ChinaOnlineStreetPurplishBlue/MapServer/tile/{z}/{y}/{x}')
    // 初始化地图
    ...
    addEchartsLayer(leafletMap)
  }

  const addEchartsLayer = (leafletMap) => {
    const overlay = new L.echartsLayer3(leafletMap, echarts)
    ...
    migrate.forEach(function (item, i) {
      series.push({
        name: item[0] + ' Top3',
        type: 'lines',
        zlevel: 1,
    ...
    // 将Echarts加到地图上，可以简单理解为在地图上添加了Echarts图层
